/**
   ...
   it under the terms of the GNU General Public License as published byZ pri
...
#define STRING_CONFIG_H_AUTHOR "(peterson, flsun Kossel Mini)" // Who made the changes.
...
*/
#define NOZZLE_TO_PROBE_OFFSET { 27.0, 5.0, -2.60 }
